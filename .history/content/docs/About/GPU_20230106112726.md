...
To some extent, we can make the minions analogy to explain the difference between CPU and GPU. A CPU is like Gru who is considerably intelligent and capable of building fantastic machines, but he can only do one thing at a time. A GPU is like a crowd of minions who are not as intelligent as Gru, but they can do build one thing collectively.
