...
For example, mobile phone data to measure mobility patterns, Consumer Register (LCR) to track social mobility and ethnicity segregation, google street view to estimate the demographic makeup of a neighborhood, and so on. 

With the growing availability of data, we need to develop new methods and tools to analyze the data. 
