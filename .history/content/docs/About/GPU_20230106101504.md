...
The main difference between CPU and GPU architecture is that a CPU is designed to handle a wide range of tasks quickly, but is limited in the concurrency of tasks that can be running. A GPU, on the other hand, is designed to handle a 



<img src="https://github.com/jasoncpit/GPU-Analytics/blob/master/Pictures/GPU_CPU.png" alt="CPU vs GPU" style="zoom:50%;" />
